          ...
          <div class="flex items-center gap-2 flex-wrap">
              ...
              <div class="relative">
                <select [value]="categoryFilter() ?? ''"
                        ...
                        [class]="categoryFilter()
                          ? 'appearance-none pl-3 pr-6 py-1.5 rounded-full text-xs font-medium border outline-none transition-colors cursor-pointer [color-scheme:dark] bg-blue-500/20 text-blue-400 border-blue-500/30'
                          : 'appearance-none pl-3 pr-6 py-1.5 rounded-full text-xs font-medium border outline-none transition-colors cursor-pointer [color-scheme:dark] bg-mm-surface border-white/[0.06] text-mm-text2 hover:border-white/10'">
                  <option value="">Todas las categorías</option>
                  @for (cat of categories(); track cat.id) {
                    <option [value]="cat.id">{{ cat.name }}</option>
                  }
                </select>
                <svg class="absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none opacity-60 text-current"
            ...
            <div class="relative ml-auto">
              <select [value]="sortOrder()"
                      ...
                      class="appearance-none pl-3 pr-6 py-1.5 rounded-full text-xs font-medium border outline-none
              ...
              <svg class="absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none text-mm-text3"
                   fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/>
              </svg>
            </div>
                ...
                <div class="w-32">
                  ...
                  <div class="relative">
                    <select formControlName="unit"
                            class="appearance-none w-full pl-3 pr-8 py-3 rounded-xl border border-white/[0.06]
                                   bg-mm-card text-mm-text1 text-sm outline-none
                    ...
                    <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none text-mm-text3"
                         fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/>
                    </svg>
                  </div>
              ...
              <div class="border-t border-white/[0.05] pt-4 mb-5 space-y-3">
                ...
                <div class="relative">
                  <select formControlName="categoryId"
                          class="appearance-none w-full pl-4 pr-8 py-2.5 rounded-xl border border-white/[0.06]
                                 bg-mm-card text-mm-text1 text-sm outline-none
                                 transition-colors focus:border-blue-500">
